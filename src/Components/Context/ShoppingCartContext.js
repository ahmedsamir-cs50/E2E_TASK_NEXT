...
// you should initialize the context with an object containing the getItemQuantity function (and other functions and state that you want to share with the component tree).
const ShoppingCartContext = createContext({
  getItemQuantity: () => 0,
...
const initialCartItems =
  typeof window !== "undefined" && localStorage.getItem("shopping-cart")
